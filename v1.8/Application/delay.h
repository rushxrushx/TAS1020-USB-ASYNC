...
//
//
#define TIMER1_MODE_16_BIT   0x01        // 8-bit timer mode

#define INIT_TIMER1  TMOD &= ~0xF0;\
                    TMOD |= (TIMER1_MODE_16_BIT << 4)
//
// Start timer 1
//
...
/*
//#define SETUP_TX1(granularity) \
//TH1 = MSB(MAX_TIMER_COUNT - granularity); \
//TL1 = LSB(MAX_TIMER_COUNT - granularity);
*/
